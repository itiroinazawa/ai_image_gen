...
class TestImageChangerAgent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.image_processor_patch = patch('src.agent.image_changer_agent.ImageProcessor')
    ...
    def test_process_image(self, mock_randint):
        ...
        # Mock PIL Image.open
        with patch('src.agent.image_changer_agent.Image.open', return_value=mock_input_image):
            # Call the method
